...
//************************** Waits Methods *********************************************//
    ...
    public void pmVerifyElementsJU( String displayMessage,String expectedMessage, WebElement element) {
        String actualMessage = pmGetTextFromElement(element);
        Assert.assertEquals( displayMessage,expectedMessage,actualMessage);
    }

    public void pmVerifyElementsTNG( WebElement element,String expectedMessage,String displayMessage ) {
        String actualMessage = pmGetTextFromElement(element);
        Assert.assertEquals( displayMessage,expectedMessage,actualMessage);
    }
